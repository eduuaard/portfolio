...
hoverChangeExperience(
  ...
  <br><br>
  ✓ Trabalhando no desenvolvimento de um software gestão para clínicas odontológicas. Laravel e MySQL estão
  sendo usados;`,
  "Desenvolvedor FullStack",
  "Devtex",
  "jun de 2023 - o momento · 6 meses"
);

hoverChangeExperience(
  ".zuplae",
  `Desenvolvimento de softwares, websites e landing pages.
  Competências: JavaScript · Vue.js · Bootstrap (Framework) · PHP · Laravel · MySQL · HTML5 · CSS`,
  "Desenvolvedor Freelancer",
  ""
  , "mar de 2023 - o momento · 9 meses"
);
